                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="profile-container">
                                    <img src="https://th.bing.com/th/id/OIP.QldbrHNbtDXJZ0d1FmJk8gHaEO?w=320&h=182&c=7&r=0&o=5&pid=1.7" alt="Gambar Profil" class="profile-image">
                                    <div class="profile-info">
                                        <h1 class="profile-name">Anton Cahyo</h1>
                                        <table class="profile-table">
                                            <tr>
                                                <td class="profile-label"><strong>Kode Dokter:</strong></td>
                                                <td class="profile-value">PKD-1</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="profile-value">926754309875</td>
                                            </tr>
                                            <tr>
                                                <td class="profile-label"><strong>Tempat Lahir:</strong></td>
                                                <td class="profile-value">Semarang</td>
                                            </tr>
                                            <tr>
                                                <td class="profile-label"><strong>Tanggal Lahir:</strong></td>
                                                <td class="profile-value">13 Januari 1988</td>
                                            </tr>
                                            <tr>
                                                <td class="profile-label"><strong>Alamat:</strong></td>
                                                <td class="profile-value">Wagom Gunung</td>
                                            </tr>
                                            <tr>
