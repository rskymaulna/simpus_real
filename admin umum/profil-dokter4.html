                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="profile-container">
                                    <img src="https://th.bing.com/th/id/OIP.qQQFgEBIORDYkQWVv-IuEAHaLH?w=184&h=276&c=7&r=0&o=5&pid=1.7" alt="Gambar Profil" class="profile-image">
                                    <div class="profile-info">
                                        <h1 class="profile-name">Annie Leonhart</h1>
                                        <table class="profile-table">
                                            <tr>
                                                <td class="profile-label"><strong>Kode Dokter:</strong></td>
                                                <td class="profile-value">PKD-2</td>
                                            </tr>
                                            <tr>
                                                <td class="profile-label"><strong>Jenis Kelamin:</strong></td>
                                                <td class="profile-value">Perempuan</td>
                                            </tr>
                                            <tr>
                                                <td class="profile-label"><strong>Nomor Induk:</strong></td>
                                                <td class="profile-value">925674893124</td>
                                            </tr>
                                            <tr>
                                                <td class="profile-label"><strong>Tempat Lahir:</strong></td>
                                                <td class="profile-value">Marley</td>
                                            </tr>
                                            <tr>
                                                <td class="profile-label"><strong>Tanggal Lahir:</strong></td>
                                                <td class="profile-value">17 Februari 1995</td>
                                            </tr>
                                            <tr>
                                                <td class="profile-label"><strong>Alamat:</strong></td>
                                                <td class="profile-value">Pasir Putih</td>
                                            </tr>
                                            <tr>
                                                <td class="profile-label"><strong>ID Poli:</strong></td>
                                                <td class="profile-value">Poli KIA</td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
