                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="profile-container">
                                    <img src="https://th.bing.com/th/id/OIP.pBcrCfuJ6Eae5u9XNPYB9QHaHa?w=219&h=219&c=7&r=0&o=5&pid=1.7" alt="Gambar Profil" class="profile-image">
                                    <div class="profile-info">
                                        <h1 class="profile-name">Eren Yeager</h1>
                                        <table class="profile-table">
                                            <tr>
                                                <td class="profile-label"><strong>Kode Dokter:</strong></td>
                                                <td class="profile-value">PGD-1</td>
                                            </tr>
                                            <tr>
                                                <td class="profile-label"><strong>Jenis Kelamin:</strong></td>
                                                <td class="profile-value">Laki-laki</td>
                                            </tr>
                                            <tr>
                                                <td class="profile-label"><strong>Nomor Induk:</strong></td>
                                                <td class="profile-value">923367529073</td>
                                            </tr>
                                            <tr>
                                                <td class="profile-label"><strong>Tempat Lahir:</strong></td>
                                                <td class="profile-value">Siganshina</td>
                                            </tr>
                                            <tr>
                                                <td class="profile-label"><strong>Tanggal Lahir:</strong></td>
                                                <td class="profile-value">20 Oktober 1997</td>
                                            </tr>
                                            <tr>
                                                <td class="profile-label"><strong>Alamat:</strong></td>
                                                <td class="profile-value">Kayu Besi, Sebrang</td>
                                            </tr>
                                            <tr>
                                                <td class="profile-label"><strong>ID Poli:</strong></td>
                                                <td class="profile-value">Poli Gigi</td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
