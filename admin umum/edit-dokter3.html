                            ...
                            <div class="card-body">
                                <table style="font-size: 15px;">
                                    <tr>
                                        ...
                                        <td class="daftar"><input type="text" id="nama input1" class="w-100 p-3" value="Anton Cahyo"></td>
                                    </tr>
                                    <tr>
                                        <td class="daftar1"><label for="nama1">Kode Dokter</label></td>
                                        <td class="daftar"><input type="text" id="nama1 input2" class="w-100 p-3" value="PKD-1"></td>
                                    </tr>
                                    <tr>
                                        <td class="daftar1"><label for="nama4">Nomor Induk Dokter</label></td>
                                        <td class="daftar"><input type="text" id="nama4 input3" class="w-100 p-3" value="926754309875"></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="daftar"><input type="text" id="nama2 input6" class="w-100 p-3" value="Semarang"></td>
                                    </tr>
                                    <tr>
                                        <td class="daftar1"><label for="nama3">Tanggal Lahir</label></td>
                                        <td class="daftar"><input type="date" id="nama3 input7" class="w-100 p-3" value="1988-01-13"></td>
                                    </tr>
                                    <tr>
                                        <td class="daftar1"><label for="nama5">Alamat</label></td>
                                        <td class="daftar"><textarea class="form-control" id="input8" aria-label="With textarea">	Wagom Gunung</textarea><td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td class="daftar">
