                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <table style="font-size: 15px;" class="table table-custom table-borderless">
                                        ...
                                        <tr>
                                            ...
                                            <td class="daftar"><input type="text" name="user" id="user" class="w-100 form-control form-control-sm"></td>
                                        </tr>
                                        <tr>
                                            <td class="daftar1">Role</td>
                                            <td class="daftar">
                                                <select name="role" id="" class="w-100 h-auto d-inline-block form-select form-select-sm">
                                        ...
                                        <tr>
                                            ...
                                            <td class="daftar"><input type="password" name="pass" id="pass" class="w-100 form-control form-control-sm"></td>
                                        </tr>
                                        <tr>
                                            <td class="daftar1"><label for="konfir_pass">Konfirmasi Password</label></td>
                                            <td class="daftar"><input type="password" name="konfir_pass" id="konfir_pass" class="w-100 form-control form-control-sm"></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td class="daftar">
