                            ...
                            <div class="card-body">
                                <table style="font-size: 15px;">
                                    <tr>
                                        ...
                                        <td class="daftar"><input type="text" id="nama" class="w-100 p-3" value="Rismawati"></td>
                                    </tr>
                                    <tr>
                                        <td class="daftar1"><label for="nama1">Kode Dokter</label></td>
                                        <td class="daftar"><input type="text" id="nama1" class="w-100 p-3" value="PUD-1"></td>
                                    </tr>
                                    <tr>
                                        <td class="daftar1"><label for="nama4">Nomor Induk Dokter</label></td>
                                        <td class="daftar"><input type="text" id="nama4" class="w-100 p-3" value="923045812347"></td>
                                    </tr>
                                    <tr>
