...
$rekmed = tampil("SELECT * FROM kunjungan 
                        ...
                        <div class="card mb-2">
                            ...
                            <div class="card mb-12" style="margin-top: 15px;">
                                ...
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm text-white" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;" onclick="printTable(1)"><i class="fas fa-print"></i> Print Rekammedis</button>   
                                </div>
                            </div>
                    </div>
                </main>
