                            ...
                            <div class="card-body">
                                <table style="font-size: 15px;">
                                    <tr>
                                        ...
                                        <td class="daftar"><input type="text" id="nama input1" class="w-100 p-3" value="Anien"></td>
                                    </tr>
                                    <tr>
                                        <td class="daftar1"><label for="nama1">Kode Dokter</label></td>
                                        <td class="daftar"><input type="text" id="nama1 input2" class="w-100 p-3" value="PUD-2"></td>
                                    </tr>
                                    <tr>
                                        <td class="daftar1"><label for="nama4">Nomor Induk Dokter</label></td>
                                        <td class="daftar"><input type="text" id="nama4 input3" class="w-100 p-3" value="929067435931"></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="daftar"><textarea class="form-control" id="input8" aria-label="With textarea">Sebrang</textarea><td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td class="daftar">
