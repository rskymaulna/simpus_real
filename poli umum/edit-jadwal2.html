                            ...
                            <div class="card-body">
                                <table style="font-size: 15px;">
                                    <tr>
                                        ...
                                        <td class="daftar"><input type="text" id="nama1" value="Anien"></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="daftar"><input type="text" id="nama2" value="13.00"></td>
                                    </tr>
                                    <tr>
                                        <td class="daftar1"><label for="nama3">Jam Selesai</label></td>
                                        <td class="daftar"><input type="text" id="nama3" value="16.30"></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td class="daftar">
