                            ...
                            <div class="card-body">
                                <table style="font-size: 15px;">
                                    <tr>
                                        ...
                                        <td class="daftar"><input type="text" id="nama input1" class="w-100 p-3" value="Rismawati"></td>
                                    </tr>
                                    <tr>
                                        <td class="daftar1"><label for="nama1">Kode Dokter</label></td>
                                        <td class="daftar"><input type="text" id="nama1 input2" class="w-100 p-3" value="PUD-1"></td>
                                    </tr>
                                    <tr>
                                        <td class="daftar1"><label for="nama4">Nomor Induk Dokter</label></td>
                                        <td class="daftar"><input type="text" id="nama4 input3" class="w-100 p-3" value="923045812347"></td>
                                    </tr>
                                    <tr>
                                        <td class="daftar1">ID Poli</td>
                                        <td class="daftar">
                                            <select name="" id="input4" class="w-100 p-3 h-auto d-inline-block">
                                                <option value="">--Pilih ID Poli--</option>
                                                <option value="" selected>Poli Umum</option>
                                    ...
                                    <tr>
                                        ...
                                        <td class="daftar">
                                            ...
                                            <label for=""></label>
                                            <label for=""></label>
                                            <input class="form-check-input" type="radio" name="gridRadios" id="gridRadios1 input5" value="option1" checked>
                                            <label class="form-check-label" for="gridRadios1">Perempuan</label> 
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="daftar1"><label for="nama2">Tempat Lahir</label></td>
                                        <td class="daftar"><input type="text" id="nama2 input6" class="w-100 p-3" value="Masohi"></td>
                                    </tr>
                                    <tr>
                                        <td class="daftar1"><label for="nama3">Tanggal Lahir</label></td>
                                        <td class="daftar"><input type="date" id="nama3 input7" class="w-100 p-3" value="1986-01-14"></td>
                                    </tr>
                                    <tr>
                                        <td class="daftar1"><label for="nama5">Alamat</label></td>
                                        <td class="daftar"><textarea class="form-control" id="input8" aria-label="With textarea">Kayu Merah, Sebrang</textarea><td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td class="daftar">
