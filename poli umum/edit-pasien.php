                            ...
                            <div class="card-body">
                                <table style="font-size: 15px;">
                                    <tr>
                                        ...
                                        <td class="daftar"><input type="text" id="nama input1" class="w-100 p-3" value="Rian"></td>
                                    </tr>
                                    <tr>
                                        <td class="daftar1"><label for="nama1">No Ktp</label></td>
                                        <td class="daftar"><input type="text" id="nama1 input2" class="w-100 p-3" value="934568219054"></td>
                                    </tr>
                                    <tr>
                                        <td class="daftar1"><label for="nama4">Nomor Bpjs</label></td>
                                        <td class="daftar"><input type="text" id="nama4 input3" class="w-100 p-3" value="219864356890"></td>
                                    </tr>
                                    <tr>
