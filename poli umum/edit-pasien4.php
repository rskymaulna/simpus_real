                            ...
                            <div class="card-body">
                                <table style="font-size: 15px;">
                                    <tr>
                                        ...
                                        <td class="daftar"><input type="text" id="nama" class="w-100 p-3" value="Bastian"></td>
                                    </tr>
                                    <tr>
                                        <td class="daftar1"><label for="nama1">No ktp</label></td>
                                        <td class="daftar"><input type="text" id="nama1" class="w-100 p-3" value="932390128926"></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="daftar"><input type="text" id="nama4" class="w-100 p-3" value="218120915128"></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="daftar"><input type="text" id="nama2" class="w-100 p-3" value="Timika"></td>
                                    </tr>
                                    <tr>
                                        <td class="daftar1"><label for="nama3">Tanggal Lahir</label></td>
                                        <td class="daftar"><input type="date" id="nama3" class="w-100 p-3" value="2000-09-30"></td>
                                    </tr>
                                    <tr>
                                        <td class="daftar1"><label for="nama5">Alamat</label></td>
                                        <td class="daftar"><textarea class="form-control" aria-label="With textarea">Imam bonjol</textarea><td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td class="daftar">
